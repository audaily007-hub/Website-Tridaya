          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-2">
              ...
              <div className="flex gap-4">
                <a href="https://www.facebook.com/share/1CzKNJYLks/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:bg-gold hover:text-navy transition-all"><Facebook size={18} /></a>
                <a href="https://www.instagram.com/tridayanusantaraglobal?igsh=OW5ib3Zoa3E4cGd6&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:bg-gold hover:text-navy transition-all"><Instagram size={18} /></a>
